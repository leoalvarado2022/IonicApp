...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuadrilleService", function() { return QuadrilleService; });
...
let QuadrilleService = class QuadrilleService {
    constructor(httpService, httpClient) {
        this.httpService = httpService;
        this.httpClient = httpClient;
        this.joinQuadrille = 'quadrille/join';
        this.transferWorkers = (data) => {
...
QuadrilleService.ctorParameters = () => [
    { type: _shared_services_http_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
QuadrilleService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
