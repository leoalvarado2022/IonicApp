...
const routes = [
    {
        path: 'auth',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-welcome-welcome-module */ "pages-welcome-welcome-module").then(__webpack_require__.bind(null, /*! ./pages/welcome/welcome.module */ "./src/app/auth/pages/welcome/welcome.module.ts")).then(module => module.WelcomePageModule)
    },
    {
        path: 'password-recovery',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-recovery-recovery-module */ "pages-recovery-recovery-module").then(__webpack_require__.bind(null, /*! ./pages/recovery/recovery.module */ "./src/app/auth/pages/recovery/recovery.module.ts")).then(module => module.RecoveryPageModule)
    },
    {
        path: 'auth/pin',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-pin-pin-module */ "pages-pin-pin-module").then(__webpack_require__.bind(null, /*! ./pages/pin/pin.module */ "./src/app/auth/pages/pin/pin.module.ts")).then(module => module.PinPageModule)
    },
    {
        path: 'expired',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-expired-expired-module */ "pages-expired-expired-module").then(__webpack_require__.bind(null, /*! ./pages/expired/expired.module */ "./src/app/auth/pages/expired/expired.module.ts")).then(module => module.ExpiredPageModule)
    },
    {
        path: '',
        redirectTo: 'auth'
