...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(platform, splashScreen, statusBar, networkService, storeService, fcm) {
  ...
  function srcAppSharedServicesStoreStoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_codewithdan_observab) {
      ...
      function StoreService() {
        ...
        _this21.setTicketTypes = function (ticketTypes) {
          var ticket = Object.assign({}, _this21.getState().ticket, {
            types: ticketTypes
          });
          ...
          _this21.setState({
            ticket: ticket
          }, _actions__WEBPACK_IMPORTED_MODULE_3__["StoreActions"].SetTicketTypes);
        };
        /**
         * getTicketTypes
         */
        ...
        _this21.getTicketTypes = function () {
          return _this21.getState().ticket.types;
        };
        /**
         * getTicketStates
         * @param ticketStates
        ...
        _this21.setTicketOrigins = function (ticketOrigins) {
          var ticket = Object.assign({}, _this21.getState().ticket, {
            origins: ticketOrigins
          });

          _this21.setState({
            ticket: ticket
          }, _actions__WEBPACK_IMPORTED_MODULE_3__["StoreActions"].SetTicketOrigins);
        };
        /**
         * getTicketOrigins
         */
        ...
        _this21.getTicketOrigins = function () {
          return _this21.getState().ticket.origins;
        };
        /**
         * setTicketPriorities
        ...
        _this21.setTicketPeriodicities = function (ticketPeriodicities) {
          var ticket = Object.assign({}, _this21.getState().ticket, {
            periodicities: ticketPeriodicities
          });

          _this21.setState({
            ticket: ticket
          }, _actions__WEBPACK_IMPORTED_MODULE_3__["StoreActions"].SetTicketPeriodicities);
        };
        /**
        ...
        _this21.getTicketPeriodicities = function () {
          return _this21.getState().ticket.periodicities;
        };
  ...
  function srcAppSharedServicesUserUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserService = function UserService(httpClient, httpService, storageService) {
      ...
      this.createUser = function (data) {
        var url = _this23.httpService.buildUrl(_this23.createUrl);

        return _this23.httpClient.post(url, data);
      };
      /**
       * updateUser
       * @param data
      ...
      this.getUser = function () {
        var url = _this23.httpService.buildUrl(_this23.userUrl);
      ...
      this.updateUser = function (data) {
        var url = _this23.httpService.buildUrl(_this23.updateUrl);

        return _this23.httpClient.put(url, _this23.httpService.buildBody(data), {
          headers: _this23.httpService.getHeaders()
        });
      };
      /**
      ...
      this.assignUser = function (data) {
        var url = _this23.httpService.buildUrl(_this23.assignUrl);

        return _this23.httpClient.post(url, _this23.httpService.buildBody(data), {
          headers: _this23.httpService.getHeaders()
        });
      };
      /**
      ...
      this.updatePassword = function (data) {
        var url = _this23.httpService.buildUrl(_this23.updatePasswordUrl);
      ...
      this.setUserRemember = function (data) {
        _this23.storageService.setRow('userRemember', data);
      };
      /**
