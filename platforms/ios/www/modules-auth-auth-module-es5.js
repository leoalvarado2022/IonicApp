...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-auth-auth-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesAuthAuthPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppModulesAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/modules/auth/pages/welcome/welcome.module.ts")).then(function (module) {
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/modules/auth/pages/recovery/recovery.module.ts")).then(function (module) {
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/modules/auth/pages/pin/pin.module.ts")).then(function (module) {
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/modules/auth/pages/expired/expired.module.ts")).then(function (module) {
  ...
  /***/
  function srcAppModulesAuthAuthPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesAuthAuthPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    AuthPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/auth/auth.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./auth.page.scss */
      "./src/app/modules/auth/auth.page.scss")).default]
