...
export class DeliveryService {
  ...
  public deleteOrderUrl = 'delete-order';
  ...
  /**
   * @description si la venta es directa es verdadero, si la venta es orders es falso
   * @param status
   */
  ...
  /**
   * @description obtener la informacion del orders
   */
  ...
  /**
   * @description agregar informacion del orders
   * @param status
   */
  ...
  /**
   * @description remover data para el form orders
   * @param status
   */
   ...
   * @description obtener la informacion del orders
   */
  public getGenerateDocument() {
    return JSON.parse(localStorage.getItem('generateDocument'));
  }
   ...
   * @param status
   */
  public setGenerateDocument(generateDocument: any) {
    localStorage.setItem('generateDocument', JSON.stringify(generateDocument));
  }
  ...
  public deleteOrder = (data: any) => {
    const url = this.httpService.buildUrl(this.deleteOrderUrl);
    return this.httpClient.post(url, this.httpService.buildBody(data), {
      headers: this.httpService.getHeaders()
    });
  };
  ...
  /**
   * @description cambiar estatus de la api orders
   * @param data
   */
  ...
  /**
   * @description obtener una orden unica de api orders
   * @param data
   */
